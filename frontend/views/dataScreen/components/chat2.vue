			...
			<div class="popup-container">
				...
				<div class="popup-body about-container">
					...
					<div class="hero-content">
						<h1>Ruth Thomson</h1>
						<p>
							I'm a front-end developer. I have dedicated myself to creating visually appealing and user-friendly websites. I'm
							always open to using new skill sets and I believe in the power of collaboration, working closely with designers and
							back-end developers to deliver cohesive and effective solution2s.
						</p>
					</div>
				</div>
			</div>
...
const toggleMaximize = (modal: HTMLElement) => {
...
onMounted(() => {
	...
	maximizeBtns.forEach(btn => {
		btn.addEventListener("click", () => {
			const modal = btn.closest(".popup") as HTMLElement | null;
			if (modal) {
...
.chaoji.prevent-background-scroll {
	min-height: 100dvh;
	overflow-y: hidden;
}
