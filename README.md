...
> % curl http://localhost:3001 (查看 nginx 是否启动)
...
# PM2 部署 node 服务
> 1. npm install pm2 -g (全局安装 pm2)
> 2. pm2 start app.js (启动 node 服务)
> 3. pm2 list (查看 pm2 进程)
> 4. pm2 stop app.js (停止 node 服务)
> 5. pm2 restart app.js (重启 node 服务)
> 6. pm2 stop all (停止所有 node 服务)
> 7. pm2 flush (清空日志)
> 8. pm2 logs (查看日志)
> 9. pm2 delete app.js (删除 node 服务)
> 10. pm2 delete all (删除所有 node 服务)
> 11. pm2 logs (查看日志)
