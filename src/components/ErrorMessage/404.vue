<template>
	...
	<div class="is404">
		...
		<nav>
			<div class="menu">
				<p class="website_name" @click="tabStore.goHome()">首页</p>
		...
		<section class="wrapper">
			<div class="container">
				...
				<div class="text">
					<article>
						<p>抱歉. <br />您访问的页面不存在~🤷‍♂️🤷‍♀️!</p>
						<button @click="tabStore.goHome()">返回首页!</button>
					</article>
				</div>
			</div>
		</section>
...
$circleShadow: inset 5px 20px 40px rgba($bg-02, 0.25), inset 5px 0px 5px rgba($bg-03, 0.3), inset 5px 5px 20px rgba($bg-03, 0.25),
